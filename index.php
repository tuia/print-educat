      ...
      <div class="page-content">
        ...
        <div class="item">
          <div class="ennunciation-container">
            ...
            </div><div class="qrcode"><?php ECHO $questao[31]; ?></div>
          </div>
          <div class="alternatives-container">
            <ol class="alternatives">
              <li>I e II.</li>
          ...
          <div class="ennunciation-container">
            <div class="ennunciation">
              <p>Os dados apresentados na tabela e no gráfico a seguir refletem, em parte, a situação da saúde pública no Brasil, com possíveis conclusões a partir dos resultados de estudos de projeção para 2020.</p>
                ...
                <table class="table table-condensed table-bordered" style="float: left;width: 45%;font-size: 9pt; margin-top: 10px">
                    <tr>
                      <th>Estado</th>
              ...
              <div class="ennunciation-img-container" style="float:right;width: 50%;display: inline-block;"><img src="img/questao63.png" style="max-width: 100%"></div>
              <div style="clear:both"></div>
              <p class="reference">Fonte: Demografia Médica no Brasil. Estudo de Projeção - Concentração de Médicos no Brasil em 2020. Conselho Federal de Medicina (CFM) e Conselho Regional de Medicina do Estado de São Paulo (Cremesp). 2015. http://portal.cfm.org.br/ - consultado em 10 setembro 2016.</p>
